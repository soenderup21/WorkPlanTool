...
public class MyDate implements Serializable
{
   ...
   /**
    * assuming that the MyDate class is set at a Monday, based on an integer you
    * can get the date of tuesday wednesday etc. 1 = Tuesday
    * 
    * @param daysAfter
    *           are days after monday
   ...
   /**
    * returns a calendar with the date of this object this object can calculate
    * Week, and day indexes
    * 
    * @return Calendar
    */
